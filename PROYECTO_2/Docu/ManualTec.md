...
El frontend está desarrollado con React y Vite. Su objetivo es proporcionar una interfaz gráfica para que el usuario pueda interactuar con el sistema sin depender de comandos en consola.
